...
```
# 현재: feat/github-reconnect — PR #45 오픈 (CI 대기 중)
# 1. PR #45 CI 통과 확인 → main 머지 → v1.11 태그
# 2. 흐름 자동 시각화 (Flow Playback) 구현 착수 — feat/flow-playback
# 3. 또는 커뮤니티 팔로우 / AI 분석 연동
```
