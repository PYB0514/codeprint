...
Proactively detects structural/architectural issues via static analysis and classifies them by severity (HIGH/MEDIUM/LOW). 21 detectors.
...
- [x] Multi-language analysis engine (tree-sitter AST) · 21 structural warning detectors + severity · false-positive calibration
...
| Plan | Details |
|---|---|
| **Free** | Effectively all features free for individual use — unlimited public projects (up to 6 private) · graph visualization · 21 structural warning types · community · AI context export (bring your own API key, BYOK) |
