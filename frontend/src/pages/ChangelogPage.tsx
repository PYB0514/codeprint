...
export const RELEASES: Release[] = [
  {
    version: 'v0.92.1',
    date: '2026-06-21',
    title: '그래프 좌측 사이드바 경량화 ① — 뷰 컨트롤을 상단 툴바로',
    type: 'fix',
    items: [
      { category: '그래프', desc: '좌측 사이드바에 세로로 길게 쌓여 있던 항목들을 정리하기 시작했습니다. 1단계로 레이아웃(계층형/도메인)·라벨(이름/주석) 토글과 프리셋·내보내기를 상단 툴바로 옮겼습니다. 프리셋과 내보내기는 버튼을 누르면 팝업으로 펼쳐져, 평소엔 자리를 차지하지 않습니다. 사이드바 스크롤이 한층 짧아졌습니다.' },
    ],
  },
  {
    version: 'v0.92.0',
