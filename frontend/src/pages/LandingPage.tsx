...
const STEPS = [
  ...
  { step: '02', title: '자동 분석 — 약 10~60초', desc: 'Tree-sitter 기반 정적 분석 엔진이 Java·TypeScript·Python·Go 등 11개 언어를 지원해 파일·함수·DB 관계를 추출한다.' },
...
function GraphMockup() {
  ...
  const domains = [
    ...
    { name: 'Analysis', color: '#f97316', x: 28, y: 165, nodes: ['Analyzer', 'GraphBuilder', 'TreeSitter'] },
