// 서비스 버전별 패치노트 데이터 — ChangelogPage.tsx에서 분리(react-refresh/only-export-components)
...
export const RELEASES: Release[] = [
  ...
  },
  {
    ...
    type: 'fix',
    items: [
      { category: '프론트', desc: '/proof 페이지의 감지기 수(19→20종)·벤치 스위트 규모(17룰×81케이스→19룰×90케이스)·지원 언어 수(13→15개) 표기를 실제 코드 기준으로 정정했습니다. 랜딩·서비스 소개 화면의 동일 수치도 함께 맞췄습니다.' },
      { category: '프론트', desc: '/proof 페이지로 가는 링크가 어디에도 없던 것을 발견해 공통 푸터에 "숫자로 보는 Codeprint" 링크를 추가했습니다.' },
      { category: '분석 엔진', desc: 'DDD 컨텍스트 경계 위반(CROSS_CONTEXT_IMPORT·CROSS_DOMAIN_CALL) 판정 시 테스트·픽스처 코드가 섞여 있으면 서로 다른 실제 컨텍스트가 하나로 잘못 합쳐져 진짜 위반을 놓칠 수 있던 문제를 고쳤습니다.' },
    ],
  },
  {
    version: 'v0.151.0',
    date: '2026-07-27',
    title: '기술 신뢰성 페이지(/proof) 신설, PR 게이트 500파일 절단 편향 해소',
    type: 'feature',
    items: [
      { category: '신규', desc: '감지기 종류·언어 지원·정확도·자기분석 결과·성능 수치를 공개하는 기술 신뢰성 페이지(/proof)를 새로 만들었습니다.' },
      { category: 'PR 게이트', desc: '변경 파일이 500개를 넘는 대형 PR에서 파일이 경로 사전순으로 잘려 특정 하위 폴더(예: frontend/)가 구조 검사에서 영구적으로 누락되던 문제를 해소했습니다 — PR로 바뀐 파일을 먼저 분석하고, 남는 한도는 폴더별로 고르게 나눠 분석합니다. 절단이 발생한 PR에는 결과가 부분 분석임을 명시합니다.' },
    ],
  },
  {
    version: 'v0.150.3',
  ...
  },
  {
    ...
    type: 'feature',
    items: [
      { category: '다국어', desc: '로그인 없이 볼 수 있는 공개 그래프 공유 화면이 영어로도 제공됩니다.' },
    ],
  },
  {
    version: 'v0.132.0',
  ...
  },
  {
    ...
    type: 'feature',
    items: [
      { category: '다국어', desc: '설정, 작동 방식, 후원, 유저 프로필, 마이페이지가 영어로도 제공됩니다. 헤더의 언어 토글로 전환할 수 있습니다.' },
      { category: 'UI', desc: '헤더의 언어·테마 전환이 토글 버튼에서 드롭다운 메뉴 방식으로 바뀌었습니다.' },
    ],
  },
  {
    version: 'v0.130.0',
  ...
  },
  {
    ...
    type: 'fix',
    items: [
      { category: '그래프 뷰어', desc: '로그인 없이 보는 공유 화면의 이름을 "그래프 뷰어"로 정리했습니다. 편집이 가능한 협업 기능과 헷갈리지 않도록 화면 라벨과 안내 문구를 통일했습니다.' },
      { category: '커뮤니티', desc: '게시글 공개범위의 "비공개 — 링크로만 접근" 옵션을 "링크 공유"로 개명하고, 선택 시 "링크가 있는 사람은 누구나 볼 수 있습니다" 안내를 표시합니다.' },
      { category: '커뮤니티', desc: '그래프 공유 시 스냅샷 설명을 추가했습니다 — 이 시점의 그래프 전체를 담은 사본으로, 확대·검색·흐름 재생은 자유롭고 수정만 할 수 없습니다.' },
    ],
  },
  {
    version: 'v0.117.2',
  ...
  },
  {
    ...
    type: 'fix',
    items: [
      { category: '랜딩', desc: '빈 URL로 "분석 시작"을 누르면 이제 입력 안내가 표시됩니다. 기능 카드 문구도 전문 용어를 줄여 다시 썼습니다.' },
      { category: '그래프', desc: '캔버스 확대/축소·화면 맞추기 버튼이 한국어로 표시됩니다. 함수 노드 정보 패널의 "타입" 표시가 항상 "-"로 뜨던 결함을 고쳤습니다.' },
      { category: '공유 그래프', desc: '좌측 노드 목록이 파일 단위로 접혀서 표시됩니다(대형 레포에서 수천 개 노드가 한 번에 나열되던 문제 개선).' },
      { category: 'AI 분석', desc: '등록된 API 키가 없으면 미리 안내하고 설정 페이지로 안내합니다.' },
      { category: '메뉴', desc: '"도그푸딩" 메뉴명을 "자체 사용 사례"로 바꿨습니다.' },
    ],
  },
  {
    version: 'v0.117.0',
  ...
  },
  {
    ...
    type: 'feature',
    items: [
      { category: '아키텍처 의도', desc: '패널 상단에 이 기능이 뭘 해주는지 설명과 "예시로 채워보기(domain ↛ infrastructure)" 버튼을 추가했습니다. 처음 접하는 사용자도 원클릭으로 동작을 바로 체험할 수 있습니다.' },
      { category: '아키텍처 의도', desc: '"감지된 구조에서 가져오기" 버튼으로 그래프가 이미 파악한 실제 폴더 구조(도메인/레이어)를 모듈로 바로 채울 수 있습니다. 빈손으로 글로브를 타이핑할 필요가 없습니다.' },
      { category: '아키텍처 의도', desc: '모듈 글로브를 입력하면 실제로 몇 개 파일이 매치되는지 즉시 표시됩니다. 매치되는 파일이 없으면 바로 경고 문구로 알려줘 오타 글로브를 조기에 발견할 수 있습니다.' },
    ],
  },
  {
    version: 'v0.115.0',
  ...
  },
  {
    ...
    type: 'fix',
    items: [
      { category: '흐름 재생', desc: '재생 패널의 도메인 뱃지가 Codeprint 자기 자신의 도메인명(project·user·graph 등)으로 고정돼 있어 다른 레포를 분석하면 뱃지가 항상 안 뜨던 문제를 고쳤습니다 — 이제 그래프 범례와 같은 방식으로 실제 폴더 구조에서 뱃지를 뽑습니다.' },
      { category: '흐름 재생', desc: '마지막 단계에서 "OO 객체가 반환됩니다"라고 표시하는 판정이 대문자로 시작하는 함수명이면 무조건 생성자로 오해하던 문제를 고쳤습니다. Go·C#은 공개 함수 전체가 대문자로 시작하는 관례라 일반 함수까지 생성자로 잘못 표시되고 있었습니다.' },
    ],
  },
  {
    version: 'v0.114.3',
    date: '2026-07-05',
    title: '문구 정정 — "런타임" 오칭·온보딩 스테일 설명·기능 안내 문서 정정',
    type: 'fix',
    items: [
      { category: '랜딩', desc: '기능 카드 "런타임 경고 감지"를 "구조 경고 감지"로 바꿨습니다 — 정적 분석 기반인데 이름이 런타임이라 바로 아래 설명("정적 분석으로 사전 감지")과 모순되던 문제입니다.' },
      { category: '온보딩 투어', desc: '레이아웃 전환 안내에 남아 있던 "허브 모드"(레이아웃 개편 전 명칭)를 실제 사양인 "도메인 모드"로 바로잡고 설명도 방사형 배치 대신 실제 동작(같은 도메인끼리 묶어 배치)으로 수정했습니다.' },
      { category: '문서', desc: '`docs/USER_FEATURES.md`가 "로그인 없이 즉시 분석"이라 적어 실제 동작(분석 시작 자체는 로그인 필요)과 어긋나 있던 부분을 정정했습니다.' },
    ],
  },
  {
    version: 'v0.114.2',
    date: '2026-07-05',
    title: '요금제 개명(Pro · Desktop) + 개인 결제 임시 중단 + 공개 레포 분석 안내',
    type: 'fix',
    items: [
      { category: '요금제', desc: '유료 플랜 이름을 "Desktop 라이센스"에서 "Pro · Desktop"으로 바꿨습니다. 데스크탑 앱(로컬 폴더 분석)은 출시 예정임을 요금제 카드에 명시했습니다.' },
      { category: '결제', desc: '개인 결제를 정기결제 도입 준비 기간 동안 임시 중단했습니다(팀 결제는 계속 가능). 마이페이지의 업그레이드 배너도 함께 내렸습니다 — 기존 배너는 이미 무료로 풀린 기능(AI·버전 히스토리)을 유료 혜택처럼 안내하고 있었습니다.' },
      { category: '랜딩', desc: 'URL 입력창 아래에 "내 레포가 아니어도 됩니다 — 공개 레포라면 무엇이든 분석할 수 있어요" 안내를 추가하고, 비로그인 상태에서는 로그인 후 분석이 자동 시작된다는 점을 미리 알려줍니다.' },
      { category: '약관', desc: '이용약관의 유료 서비스 설명을 실제 혜택(협업 인원 제한 해제, 팀 생성·좌석 관리)에 맞게 바로잡았습니다.' },
    ],
  },
  {
    version: 'v0.114.1',
    date: '2026-07-05',
    title: '경고 설명 전면 재작성 — 전문용어 없이 원인과 조치를 바로 이해할 수 있게',
    type: 'fix',
    items: [
      { category: '경고 패널', desc: '15종 경고의 이름과 설명을 쉬운 말로 다시 썼습니다. 각 경고가 "무엇이 문제이고, 왜 위험하며, 무엇을 하면 되는지"를 한눈에 알 수 있습니다. "아키텍처 의도" 위반 경고(INTENT_DRIFT)가 코드명 그대로 노출되던 것도 정식 이름·설명을 갖췄습니다.' },
      { category: '작동 방식 페이지', desc: '경고 가이드에 빠져 있던 5종(기능 폴더 간 직접 참조, 레이어 단방향 위반, 레이어 역전 의존, Service 계층 건너뛰기, 선언한 구조 규칙 위반)의 예시와 한계 설명을 추가해 15종 전부를 다룹니다.' },
      { category: '경고 내보내기', desc: '경고 마크다운 리포트의 제목을 "구조 경고 리포트"로 바로잡고, 일부 경고 타입이 코드명으로만 표기되던 문제를 수정했습니다(경고 이름을 패널과 단일 소스로 통일).' },
    ],
  },
  {
    version: 'v0.114.0',
  ...
  },
  {
    ...
    type: 'feature',
    items: [
      { category: '커뮤니티', desc: '그래프를 게시글에 첨부할 때 저장해둔 뷰(프리셋)를 선택하면, 등록 시점의 설정이 그대로 스냅샷으로 고정됩니다. 이후 프리셋을 수정해도 이미 등록된 게시글은 영향받지 않습니다.' },
      { category: '커뮤니티', desc: '게시글을 공개(커뮤니티 피드에 표시) 또는 비공개(직접 링크로만 접근)로 설정할 수 있습니다.' },
    ],
  },
  {
    version: 'v0.109.0',
  ...
  },
  {
    ...
    type: 'fix',
    items: [
      { category: '보안', desc: '결제 승인(Pro 플랜·팀 생성/좌석 변경) 요청이 더블클릭이나 네트워크 재시도로 짧은 시간에 중복 전송되는 경우, 승인 처리가 중복 실행될 수 있던 문제를 수정했습니다. 이제 동일 주문에 대한 동시 요청은 안전하게 하나만 처리되고 나머지는 이미 처리됨으로 응답합니다.' },
    ],
  },
  {
    version: 'v0.108.0',
  ...
  },
  {
    ...
    type: 'feature',
    items: [
      { category: '공유 그래프', desc: '로그인 없이 보는 공유 그래프(/share/{id})에서도 노드 라벨을 이름/주석 중 골라 볼 수 있는 전환 버튼을 추가했습니다. 이전에는 로그인한 소유자용 화면(GraphPage)에만 있던 기능입니다.' },
      { category: '공유 그래프', desc: '노드 검색 결과가 함수/파일 주석까지 매치하도록 개선했습니다(이전엔 이름만 검색). 결과도 최대 10개로 제한해 더 빠르게 원하는 항목을 찾을 수 있습니다.' },
    ],
  },
  {
    version: 'v0.105.0',
    ...
    items: [
      ...
      { category: '공유 그래프', desc: '좌우 사이드바를 접어서 화면을 넓게 쓸 수 있는 버튼을 추가했습니다. 마우스 휠로 화면을 축소할 수 있는 범위도 넓혔습니다(로그인한 소유자용 화면과 동일하게).' },
    ],
  },
  {
    version: 'v0.104.3',
    date: '2026-07-02',
    title: 'C# 분석 정확도 개선 — 전처리기 지시문 주변 이름 손상으로 인한 잘못된 경고 제거',
    type: 'fix',
    items: [
      { category: '분석 엔진', desc: 'C# 코드에서 #if/#endif 조건부 컴파일 지시문 주변의 메서드가 이름이 깨진 채로 잘못된 "데드 코드" 경고를 발생시키던 문제를 수정했습니다.' },
    ],
  },
  {
    version: 'v0.104.2',
    ...
    type: 'fix',
    items: [
      { category: '랜딩페이지', desc: '미사용 광고 배너 영역(좌/우/하단)을 제거하고, 정적 그래프 예시 이미지를 실제 라이브 분석 사례인 "오늘의 공개레포" 섹션으로 대체했습니다.' },
      { category: '랜딩페이지', desc: '요금제 카드 문구를 실제 기능 제공 범위에 맞게 수정했습니다. AI 설명/코드 생성·그래프 버전 히스토리·경고 MD 내보내기는 Free 플랜에서도 이미 사용 가능해 Free 항목으로 옮겼습니다.' },
      { category: '랜딩페이지', desc: '"사용법" 섹션을 상단으로 옮기고 "주요 기능"과 나란히 배치했습니다. 그 아래에 "오늘의 공개레포"를 배치했습니다.' },
    ],
  },
  {
    version: 'v0.104.1',
  ...
  },
  {
    ...
    type: 'infra',
    items: [
      { category: '성능', desc: '같은 저장소를 다시 분석하거나 PR을 검사할 때, 내용이 바뀌지 않은 파일은 이전 분석 결과를 재사용하고 변경된 파일만 다시 파싱합니다. 대부분 파일이 그대로인 재분석·PR 검사에서 분석 시간이 크게 줄어듭니다. 결과 그래프는 전체를 다시 분석한 것과 동일합니다(파일 내용 해시로 변경을 감지).' },
    ],
  },
  {
    version: 'v0.100.3',
    date: '2026-06-29',
    title: '분석 안정성 개선 — 멈춤 방지·자동 복구',
    type: 'fix',
    items: [
      { category: '안정성', desc: '분석이 영구히 "분석 중"에 멈추던 경로들을 막았습니다. 진행률 폴링이 일시적 네트워크 오류로 한 번 실패해도 즉시 멈추지 않고 재시도하며, 정말 끊기면 실패로 표시해 다시 시도할 수 있게 합니다. 분석이 비정상적으로 오래(약 3분 이상) 걸리면 "예상보다 오래 걸립니다" 안내와 재시도 버튼을 보여줍니다.' },
      { category: '안정성', desc: '서버가 클론 단계에서 멈추지 않도록 타임아웃(120초)과 자격증명 프롬프트 차단을 추가했고, 서버가 재시작되면 도중에 끊긴 분석을 자동으로 실패 처리해 다시 시도할 수 있게 정리합니다(이전에는 영구히 진행 중 상태로 남았습니다).' },
    ],
  },
  {
    version: 'v0.100.2',
    date: '2026-06-29',
    title: '프로젝트 생성 시 자동 분석 시작',
    type: 'fix',
    items: [
      { category: '사용성', desc: '새 프로젝트를 만들면 곧바로 기본 브랜치 분석이 자동으로 시작됩니다. 그동안 안내문에는 "자동 분석"이라고 적혀 있었지만 실제로는 생성 후 "분석 시작 → 브랜치 선택"을 직접 눌러야 분석이 돌았습니다. 이제 생성 즉시 진행률이 표시되고 분석이 끝나면 회로도 화면으로 바로 이동합니다.' },
    ],
  },
  {
    version: 'v0.100.1',
  ...
  },
  {
    ...
    type: 'feature',
    items: [
      { category: '구조 경고', desc: '의도된 아키텍처 패턴(예: CQRS 읽기 전용 서비스가 영속화 계층을 직접 호출)을 경고 하나하나 숨기지 않고, 패턴 규칙 한 줄로 한 번에 끌 수 있습니다. 경고 옆 "무시"를 누르면 출발/도착 파일에서 글로브를 자동 추론한 폼이 뜨고, "이 규칙은 N개 경고를 끕니다" 미리보기로 과도한 억제를 막습니다. 추가한 규칙은 경고 패널 상단 "예외 규칙"에서 모아 보고 제거할 수 있으며, 제거하면 해당 경고가 다시 나타납니다. (개별 숨김 ✕도 그대로 유지)' },
    ],
  },
  {
    version: 'v0.94.5',
  ...
  },
  {
    ...
    type: 'fix',
    items: [
      { category: '성능', desc: '프로필의 팔로워·팔로잉 목록을 불러올 때 사람마다 유저 정보를 따로 조회하던 것을, 한 번에 묶어 조회하도록 바꿨습니다. 팔로워가 많은 유저의 목록을 열 때의 응답 속도를 개선했습니다. 표시 내용·순서는 동일합니다.' },
    ],
  },
  {
    version: 'v0.93.19',
