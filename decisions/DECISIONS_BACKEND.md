...
**DDD 결정.**
- PrReviewService를 **analysis 컨텍스트**에 배치(분석 주도 기능). 프로젝트 접근은 같은 컨텍스트의 `AnalysisFacade` 경유, 경고는 `GraphFacade.detectWarnings` 경유 → `domain/graph`·`application/project` 직접 import 회피.
