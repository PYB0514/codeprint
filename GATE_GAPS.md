...
### [G-6] HikariCP 유휴 커넥션 고갈 후 재사용 시 EOFException — G-4·G-5와 다른 네 번째 실패 지점 · `[재발방지 사실상 완료로 추정(근본 원인 수정 후 재검증): reconcile 사각지대 해소 + HikariCP 튜닝이 PR #609로 실제 적용된 뒤 8분 관찰 재발 없음 — 확정은 다음 세션 추가 관찰 후]` (2026-07-17, PR #597)
