...
### [G-6] HikariCP 유휴 커넥션 고갈 후 재사용 시 EOFException — G-4·G-5와 다른 네 번째 실패 지점 · `[재발방지 완료: reconcile 사각지대 해소 + HikariCP 튜닝(minimum-idle 2·max-lifetime 120000)]` (2026-07-17, PR #597)
